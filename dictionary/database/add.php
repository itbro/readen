<?php
    ...
    if (($_POST['lel'] != '') && ($_POST['meaning'] != '')) {
        $db->exec("INSERT INTO dictionary VALUES (null, '{$_POST['lel']}',
            '{$_POST['meaning']}', '{$_POST['comment']}', '{$_POST['example']}',
            '$example_pure', '{$_POST['label']}', '{$_POST['source_from_add']}',
            '{$_POST['descript']}', '{$_POST['unsure']}', CURDATE())");
    }

    setcookie("source_from_add", $_POST['source_from_add']);
